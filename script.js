...
const logo = document.getElementById("nav-logo-txt", "nav-logo-img");
...
const TOP_PROJECTS = [
  {
    ...
    status: "Active",
    description:
      "Personal dev lab — portfolio, about me, projects, notes, and experiments.",
    stack: ["CSS", "HTML", "JS"],
  ...
  },
  {
    ...
    status: "Planned",
    description:
      "A student-built platform for notes, PDFs, sample papers and educational resources.",
  ...
  },
  {
    ...
    status: "Active",
    description:
      "Python-based system for automated attendance using facial recognition via webcam.",
  ...
  },
  {
    ...
    status: "Paused",
    description:
      "A simple weather application using PyQt5 and OpenWeather API for real-time weather updates.",
  ...
  },
  {
    ...
    status: "Archived",
    description:
      "Python-based AI assistant that automates tasks like opening Websites, time checks, and calculations.",
...
function renderTopProjects() {
  PROJECTS_GRID.innerHTML = TOP_PROJECTS.map(
    (project) => `
        <div class="project">
        ...
        ${project.stack
          .map((t) => `<div class="project-stack">${t}</div>`)
          .join("")}
